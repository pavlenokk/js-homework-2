let simpsons = [
    ...
    },
    {
        ...
        surname: 'Simpson',
        age: 9,
        info: 'Ли́за Мари́ Си́псон (англ. Lisa Marie Simpson) — героиня мультипликационного сериала «Симпсоны». Средний ребёнок в семье, восьмилетняя девочка, выделяющаяся среди остальных Симпсонов прежде всего своим умом и рассудительностью.',
...
for (const simpson of simpsons) {
    ...
    h.innerText=`${simpson.name} ${simpson.surname} age: ${simpson.age}`;
...
for (const course of coursesArray) {
    ...
    let title = document.createElement('course');
    ...
    title.appendChild(modulesElement);
...
div.style.color='Red';div.style.background='Yellow';div.style.fontSize='10px';
document.body.appendChild(div);
